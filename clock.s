 /* clock.s
 *
 * Last Updated: 24 Dec 2020 by Benjamin Hicks
 * Author: Wes, Dr. Schwartz
 *
 * This assembly file is taken from the course EEL3744C
 * at the University of Florida. The purpose if clock_init()
 * is to enable the 32MHz internal oscillator and then select
 * the 32MHz source as the clock source
 *
 * This must be done in assembly due to the limited window we
 * have to modify the protected registers, given to us by the
